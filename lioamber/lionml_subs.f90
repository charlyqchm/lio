...
subroutine lionml_write_dull()
   ...
   write(*,8243) inputs%ke_lmin, inputs%ke_lmax, inputs%ke_degen
! General
9000 FORMAT(A)
...
8243 FORMAT(2x, "ke_lmin = ", I6, ", ke_lmax = ", I6, ", ke_degen =", ES9.2)
   return
...
8811 FORMAT(4x,"║  ke_lmax             ║  ",21x,F14.8,2x,"║")
