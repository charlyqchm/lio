...
module lionml_data
   ...
   use tbdft_data         , only: tbdft_calc, MTB, alfaTB, betaTB, gammaTB,    &
                                 ...
                                 tbdft_transport, driving_rateTB
...
!  Namelist definition
   ...
   namelist /lio/ OPEN, NMAX, Nunp, VCINP, GOLD, told, Etold, rmax, rmaxs,     &
                  ...
                  start_tdtb, end_tdtb, tbdft_transport, driving_rateTB,       &                               &
                  !Fockbias
                  fockbias_is_active, fockbias_is_shaped, fockbias_readfile,   &
                  fockbias_timegrow , fockbias_timefall , fockbias_timeamp0,   &
                  ! Libxc variables
   ...
   type lio_input_data
      ...
      double precision :: alfaTB, betaTB, driving_rate, gammaTB, Vbias_TB,     &
                          driving_rateTB
      logical          :: tbdft_calc, gate_field, generate_rho0,               &
                          transport_calc
      integer          :: end_bTB, end_tdtb, MTB, pop_drive, save_charge_freq, &
                          start_tdtb, nbias, tbdft_transport
      ! Ehrenfest
...
subroutine get_namelist(lio_in)
   ...
   lio_in%tbdft_transport  = tbdft_transport ; lio_in%start_tdtb= start_tdtb
